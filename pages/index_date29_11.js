          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            ...
            >
              ...
              <p className="text-sm text-slate-300 sm:text-[15px]">
                CRS quietly reads your public videos — titles, descriptions,
                posting cadence — and turns them into a strategic snapshot:
                identity, momentum, and realistic next moves.
              </p>
            </motion.div>
        ...
        >
          <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 sm:px-6 lg:flex-row lg:items-center lg:py-16">
            ...
            >
              ...
              <p className="text-sm text-slate-300 sm:text-[15px]">
                CRS is your quiet strategist. It doesn&apos;t replace your taste — it
                focuses it. You keep the voice. We highlight the patterns that
                actually move your channel.
              </p>
            ...
            >
              <div className="card-glass relative overflow-hidden px-4 py-4 sm:px-6 sm:py-5">
                ...
                <p className="mt-1 text-xs text-slate-300">
                  You&apos;re strongest when you teach, but your upload timing and
                  brand picks are leaving trust — and views — on the table.
                </p>
                ...
                <div className="mt-4 rounded-2xl border border-slate-800 bg-slate-900/80 px-3 py-2.5 text-[11px]">
                  ...
                  <p className="mt-1 text-slate-300">
                    Post 1 long-form deep dive per week + 2 shorts that reuse
                    the same hook. Protect 2 upload slots for only taking deals
                    with 80%+ CRS brand-fit.
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        >
          <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-12 sm:px-6 lg:flex-row-reverse lg:items-center lg:py-16">
            ...
            >
              ...
              <p className="text-sm text-slate-300 sm:text-[15px]">
                Instead of guessing which creator will land your message, CRS
                turns their existing content into a brand-fit profile. You see
                alignment, risk level, and audience overlap in one glance.
              </p>
              <ul className="mt-3 space-y-2 text-xs text-slate-300 sm:text-[13px]">
            ...
            >
              <div className="card-glass relative overflow-hidden px-4 py-4 sm:px-6 sm:py-5 text-[11px] text-slate-200">
                ...
                <p className="mt-1 text-slate-300">
                  You&apos;re considering a sponsorship for{" "}
                  <span className="font-semibold">FocusFlow</span>, a deep-work
                  timer app.
                </p>
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl border border-slate-800 bg-slate-900/80 px-3 py-2.5">
                    ...
                    <p className="mt-1 text-slate-300">
                      Their audience skews ambitious, system-obsessed, and
                      already talking about burnout and focus.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-slate-800 bg-slate-900/80 px-3 py-2.5">
                    ...
                    <p className="mt-1 text-slate-300">
                      Biggest risk is over-saturation with similar SaaS.
                      Recommend story-first integration, not pure feature demo.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl border border-slate-800 bg-slate-900/80 px-3 py-2.5">
                    ...
                    <p className="mt-1 text-slate-300">
                      &ldquo;I rebuilt my attention span in 30 days&rdquo; —
                      FocusFlow is the tool, not the hero.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-slate-800 bg-slate-900/80 px-3 py-2.5">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-400">
                    ...
                    <p className="mt-1 text-slate-300">
                      High tolerance for tools, low tolerance for inauthentic
                      reads. The creator should show their real screen, not a
                      script.
                    </p>
                  </div>
                </div>
              ...
              <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-300 sm:text-[13px]">
                    Drop your email and YouTube handle. We&apos;ll invite a
                    small batch of channels across different niches to shape
                    what this becomes.
                  </p>
                </div>
                <form
                ...
                >
                  ...
                  <p className="text-[10px] text-slate-500">
                    No spam, no list flipping. Just product updates and a chance
                    to steer CRS.
                  </p>
                </form>
              </div>
